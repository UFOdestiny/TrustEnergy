...
from src.engines.trustenergy import TrustEnergy_Engine
import torch

from src.models.trustenergy import TrustEnergy
...
def main():
    ...
    model = TrustEnergy(node_num=node_num,
                  gso=gso,
                  blocks=blocks,
                  Kt=args.Kt,
                  Ks=args.Ks,
    ...
    engine = TrustEnergy_Engine(device=device,
                                    model=model,
